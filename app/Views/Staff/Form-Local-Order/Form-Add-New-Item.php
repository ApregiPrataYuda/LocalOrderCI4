          ...
          <div class="col-md-6 mt-2">
            ...
            <div class="col-md-4">
				...
				<div class="form-group row ml-6">
					<label class="col-sm-2 col-form-label text-uppercase">Select Division  :</label>
					<div class="col-sm-5">
                ...
                <div class="form-group row ml-6">
					<label class="col-sm-2 col-form-label text-uppercase">SELECT NO LOCAL ORDER :</label>
					<div class="col-sm-5">
                ...
                <div class="form-group row ml-6">
					...
					<div class="col-sm-5">
                    <button id="openModal" class="btn btn-outline-info" data-toggle="modal" data-target="#myModal"><i class="fa fa-search" aria-hidden="true"></i> views</button>
					</div>
				</div>
       ...
       <h3 class="card-title text-dark font-weight-bolder float-left">DETAIL</h3>
          ...
          <div class="card-body">
           <!-- start code Button -->
            ...
            <button type="button" id="saveButtonAgain" class="btn btn-sm btn-outline-info"><i class="fa fa-save"></i> Save Data</button>
            <!-- end code Button -->
            <hr>
            <!-- start code check -->
            <div class="row mt-1">
...
<!-- code save data -->
<script>
$('#saveButtonAgain').click(function() {
    ...
    if (isValid) {
        ...
        //start proses aksi kirim data
            $.ajax({
                    url: '<?= base_url('send-data-request-order-again') ?>',
                    method: 'POST',
                    data: $('#formLoAgain').serialize(),
                    beforeSend: function() {
                        $('#saveButtonAgain').prop('disabled', false).text('Sedang proses...');
                    },
                ...
                if (response.trim() === 'oke') {
                    Swal.fire({
                        ...
                        $('#saveButtonAgain').prop('disabled', true).text('Data Save Failed');
                         window.location.href = '<?= base_url('add-item-again') ?>';
                    });
                    ...
                    Swal.fire({
                        ...
                        $('#saveButtonAgain').prop('disabled', false).text('Success Save Data');
                         window.location.href = '<?= base_url('add-item-again') ?>';
                    });
