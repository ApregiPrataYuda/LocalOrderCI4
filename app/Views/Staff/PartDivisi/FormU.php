...
<li class="breadcrumb-item"><a href="<?= base_url('Parts-Division')?>">Back</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <!-- <div class="card"> -->
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('Update-data-part-divisi') ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="PartName" name="PartName" value="<?= $row->PartName?>" placeholder="Part Name" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="partID" name="partID" value="<?= $row->partID?>" placeholder="Part ID" readonly>
                                <input type="hidden" class="form-control" id="id" name="id" value="<?= $encryptionService->encryptId($row->id) ?>" readonly>
                            ...
                            <?php 
                                ...
                                <option value="<?= $data ?>" <?=$data == $row->divisiID ? "selected" : null?>><?= $data ?></option>
                                <?php  } ?>
                            </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="standart_Pack" name="standart_Pack" value="<?= $row->standart_Pack?>" placeholder="Enter standart Pack">
                            ...
                            <?php foreach ($unitData as $key => $value) { ?>
                                <option value="<?= $value['UnitID'] ?>" <?=  $value['UnitID'] == $row->unitID_StdPack ? "selected" : null?>><?= $value['UnitID'] ?> - <?= $value['UnitName'] ?></option>
                            <?php  } ?>
                            </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="safety_Stock" name="safety_Stock" value="<?= $row->safety_Stock?>" placeholder="Enter Safety Stock">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="minimum_Order" name="minimum_Order" value="<?= $row->minimum_Order?>" placeholder="Enter minimum Order">
                            ...
                            <option value="">-Select-</option>
                            <?php foreach ($unitData as $key => $value) { ?>
                                <option value="<?= $value['UnitID'] ?>" <?=  $value['UnitID'] == $row->UnitID_Stock ? "selected" : null?>><?= $value['UnitID'] ?> - <?= $value['UnitName'] ?></option>
                            <?php  } ?>
                            </select>
                            ...
                            <option value="">-Pilih-</option>
                            <option value="1" <?= ($row == '1' || (isset($row->Is_Active) && $row->Is_Active == '1')) ? 'selected' : '' ?>>AKTIF</option>
                            <option value="0" <?= ($row == '0' || (isset($row->Is_Active) && $row->Is_Active == '0')) ? 'selected' : '' ?>>NONAKTIF</option>
                            </select>
