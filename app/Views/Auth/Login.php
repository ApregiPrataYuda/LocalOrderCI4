...
<form action="<?= base_url('Auth-login-main')?>" method="post" id="loginForm">
...
<?php if (session()->get('errors.Branch')) : ?>
  <div class="text-danger font-weight-bolder font-italic"><?= esc(session()->get('errors.Branch')) ?></div>
<?php endif ?>
<div class="card mb-2">
  <div class="card-body">
